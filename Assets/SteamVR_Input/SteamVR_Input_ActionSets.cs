...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_hapticglove p_hapticglove;
        ...
        public static SteamVR_Input_ActionSet_hapticglove hapticglove
        {
            get
            {
                return SteamVR_Actions.p_hapticglove.GetCopy<SteamVR_Input_ActionSet_hapticglove>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_hapticglove = ((SteamVR_Input_ActionSet_hapticglove)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_hapticglove>("/actions/hapticglove")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.hapticglove};
        }
    }
}
